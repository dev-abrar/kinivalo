                                    ...
                                    <tbody id="tableData">
                                        ...
                                        @forelse ($permissions as $permission)
                                            <tr class="rowSort" id="{{ $permission->id }}">
                                                <td>{{ $serial++ }}</td>
                                                <td>
                                                    <span class="text-success">{{ $permission->display_name }}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <button
                                                        ...
                                                        data-permission="{{ $permission }}"><i class="fas fa-edit"></i>
                                                        Edit
                                                    </button>
                                                    <a href="{{ url('child-permission/' . $permission->id) }}"
                                                        class="btn btn-info btn-sm rounded-pill btn-rounded text-light">
                                                        Child Permission
                                                    </a>
                                                </td>
                                            </tr>
