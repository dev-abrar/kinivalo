                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{{ url('orders/delete/'. $order->id) }}" id="delete" class="btn btn-danger">Delete</a>
                        </td>
                      </tr>
  ...
  columns:[
    ...
    },
    {
      ...
      render: function(data,type,full,meta){
        var data = `${full['customer_name']}<br>${data}<br>${full['delivery_address']}`;
        return data;
      }
    },
    {
...
$('#orders tbody').on('click', '.view', function () {
    var id = $(this).attr('id');
    window.open("{{ url('admin/orders/') }}/" + id, '_blank');
});
