...
class NewOrderCustomer extends Notification
{
    ...
    public function toMail($notifiable)
    {
      $products = OrderDetail::join('products','products.id','order_details.product_id')
                  ->where('order_details.order_id',$this->order->id)->get(array('products.title','products.img1','order_details.product_qty','order_details.product_price','order_details.total_price','order_details.options'));
